# Yêu cầu đồ án — Hệ thống quản trị quy trình nghiệp vụ
...
## 1. Liệt kê tối thiểu 10 quy trình — 10 điểm
...
|----------------|-------------------|------------|
| Quy trình quản lý | 3 | Quy trình định hướng, kiểm soát (ví dụ: hoạch định, duyệt nhà cung cấp, quản lý tồn kho) |
| Quy trình cốt lõi | 3 | Quy trình tạo giá trị trực tiếp cho khách hàng (bán hàng, giao hàng, đổi trả…) |
| Quy trình hỗ trợ | 3 | Quy trình hỗ trợ vận hành (nhân sự, tài chính, công nghệ thông tin…) |
| Vẽ kiến trúc quy trình | — | Thêm 1 điểm nếu có sơ đồ kiến trúc bao quát đủ tổng số quy trình đã liệt kê |

**Với mỗi quy trình, báo cáo cần nêu đủ bốn nội dung:**

1. **Tác nhân:** ai (hoặc hệ thống nào) tham gia thực hiện.  
2. **Mô tả bằng lời:** các bước chính của quy trình.  
3. **Khách hàng của quy trình:** bên nhận kết quả đầu ra (có thể là khách mua hàng hoặc bộ phận nội bộ).  
4. **Kết quả có thể xảy ra:** đầu ra thành công và các trường hợp kết thúc có kiểm soát (ví dụ: hủy đơn, từ chối đổi trả).

---

## 2. Mô hình hóa quy trình — 10 điểm
...
### Độ phức tạp — cổng điều kiện

**Cổng điều kiện** là ký hiệu trên sơ đồ BPMN thể hiện chỗ quy trình phải chọn nhánh (ví dụ: đủ điều kiện giao 2 giờ hay không). Trong môn học thường dùng cổng **XOR** (chỉ đi đúng một nhánh).
...
Khi chấm, giảng viên còn xem: tách nhánh và gộp nhánh (split/join) có đúng không; ký hiệu BPMN có sai không; hoạt động trong quy trình có hợp lý không.
...
|--------------|-------------------|--------|
| Câu hỏi định tính | 10 | 5 câu có cấu trúc (chọn đáp án / khoảng) + 5 câu không cấu trúc (mở) |
| Câu hỏi định lượng | 10 | 5 câu có cấu trúc + 5 câu không cấu trúc |
...
### 4.1. Phân tích định tính — 2 quy trình
...
### 4.2. Phân tích định lượng — 2 quy trình

Tính toán trên quy trình bằng bảng; sau đó đề xuất khắc phục. Cần có:

1. **Thời gian** (từng bước hoặc tổng chu kỳ)  
...
- [ ] Có từ 10 quy trình trở lên; mỗi quy trình đủ tác nhân, mô tả bước, khách hàng quy trình, kết quả  
- [ ] Đủ ít nhất 3 quản lý, 3 cốt lõi, 3 hỗ trợ; có vẽ kiến trúc quy trình  
- [ ] BPMN: 2 quản lý + 2 cốt lõi + 2 hỗ trợ; chú ý cổng điều kiện, tách/gộp nhánh, ký hiệu  
- [ ] Slide trình bày sâu 1 quy trình; Word có ít nhất 2 mô hình  
- [ ] Bằng chứng + phỏng vấn: 10 câu định tính + 10 câu định lượng (mỗi loại 5 có cấu trúc / 5 không cấu trúc)  
